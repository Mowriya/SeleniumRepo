...
EdgeDriver driver = new EdgeDriver();
		...
		driver.findElement(By.xpath("//input[contains (@id,'firstName')]")).sendKeys("Mowriya");
		//input[contains (@id, 'lastName')]
		driver.findElement(By.xpath("//input[contains (@id, 'lastName')]")).sendKeys("Rajendran");
		//input[contains (@id, 'firstNameLocal')]
		driver.findElement(By.xpath("//input[contains (@id, 'firstNameLocal')]")).sendKeys("Mowri");
		...
		driver.findElement(By.xpath("//input[contains (@id, 'primaryEmail')]")).sendKeys("mowriya.r@gmail.com");
		//select[contains (@id, 'StateProvinceGeoId')]
		
        WebElement  mow = driver.findElement(By.xpath("//select[contains (@id, 'StateProvinceGeoId')]"));
		
		Select su= new Select(mow);
